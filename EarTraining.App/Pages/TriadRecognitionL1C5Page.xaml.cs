...
public partial class TriadRecognitionL1C5Page : ContentPage, IAutomatableDrill
{
    ...
    private readonly IReadOnlyList<DiatonicTriadDrill> _all = DiatonicTriadDrill.All(4); // I/IV/V/vi
    private DiatonicTriadDrill _drill = null!;
    private bool _answered;
    private bool _ready;

    public TriadRecognitionL1C5Page()
    {
        InitializeComponent();
