...
public partial class TriadProgressionsL1C5Page : ContentPage, IAutomatableDrill
{
    ...
    private L1C5ProgressionDrill _drill = null!;
    private bool _answered;
    private bool _ready;

    public TriadProgressionsL1C5Page()
    {
        InitializeComponent();
    ...
    private IReadOnlyList<L1C5ProgressionDrill> Set =>
        ThreeChord ? L1C5ProgressionDrill.ThreeChord : L1C5ProgressionDrill.TwoChord;

    private List<L1C5ProgressionDrill> Playable()
    {
    ...
    private async Task PlayDrillAsync(L1C5ProgressionDrill drill)
    {
