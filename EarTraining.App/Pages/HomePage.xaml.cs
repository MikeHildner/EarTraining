...
public partial class HomePage : ContentPage
{
    ...
    private static readonly Group[] Groups =
    {
        new("Level 1 · Foundations", new[]
        {
            ...
            Chapter("Chapter 4", "I, IV, V triads", new("Melody Harmonization", "l1c4harmonize"), new("Triad Progressions", "l1c4progressions"), new("Dictation", "l1c4dictation")),
            Chapter("Chapter 5", "Diatonic 4ths & 5ths", new("Vocal Drills", "l1c5vocal"), new("Melodic Intervals", "l1c5melodic"), new("Harmonic Intervals", "l1c5harmonic"), new("Triad Recognition", "l1c5triad"), new("Triad Progressions", "l1c5progressions"), new("Dictation", "l1c5dictation")),
            Chapter("Chapter 6", "Maj 2nd & min 7th", new("Vocal Drills", "l1c6vocal"), new("Melodic Intervals", "l1c6melodic"), new("Harmonic Intervals", "l1c6harmonic"), new("Triad Recognition", "l1c6triad"), new("Triad Progressions", "l1c6progressions"), new("Dictation", "l1c6dictation")),
            Chapter("Chapter 7", "Min 2nd & maj 7th", new("Vocal Drills", "l1c7vocal"), new("Melodic Intervals", "l1c7melodic"), new("Harmonic Intervals", "l1c7harmonic"), new("Triad Recognition", "l1c7triad"), new("Triad Progressions", "l1c7progressions"), new("Dictation", "l1c7dictation")),
        }),
