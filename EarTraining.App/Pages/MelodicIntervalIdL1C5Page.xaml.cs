...
public partial class MelodicIntervalIdL1C5Page : ContentPage, IAutomatableDrill
{
    ...
    public MelodicIntervalIdL1C5Page()
    {
        InitializeComponent();
    ...
    private List<(int idx, L1C5IntervalDrill drill)> Pool()
    {
        ...
        for (int i = 0; i < L1C5IntervalDrill.Melodic.Count; i++)
        {
            var d = L1C5IntervalDrill.Melodic[i];
    ...
    private void BuildAnswers()
    {
        ...
        // One button per distinct quality-category among the playable prompts, in table order.
