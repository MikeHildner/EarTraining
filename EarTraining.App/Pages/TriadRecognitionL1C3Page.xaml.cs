...
public partial class TriadRecognitionL1C3Page : ContentPage, IAutomatableDrill
{
    ...
    private readonly IReadOnlyList<DiatonicTriadDrill> _all = DiatonicTriadDrill.All();
    private DiatonicTriadDrill _drill = null!;
    private bool _answered;
    private bool _ready;

    public TriadRecognitionL1C3Page()
    {
        InitializeComponent();
    ...
    private void OnScoreModeChanged(object? sender, CheckedChangedEventArgs e)
    {
        ...
        BuildAnswers();
        Gauge.Reset();                     // the two tallies aren't comparable — start fresh
        _answered = false;
        StatusLabel.Text = string.Empty;
    }
