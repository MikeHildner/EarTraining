...
public partial class TriadProgressionsL1C6Page : ContentPage, IAutomatableDrill
{
    ...
    private L1C6ProgressionDrill _drill = null!;
    private bool _answered;
    private bool _ready;

    public TriadProgressionsL1C6Page()
    {
        InitializeComponent();
    ...
    private IReadOnlyList<L1C6ProgressionDrill> Set =>
        ThreeChord ? L1C6ProgressionDrill.ThreeChord : L1C6ProgressionDrill.TwoChord;

    private List<L1C6ProgressionDrill> Playable()
    {
