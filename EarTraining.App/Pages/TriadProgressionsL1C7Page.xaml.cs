...
public partial class TriadProgressionsL1C7Page : ContentPage, IAutomatableDrill
{
    ...
    private L1C7ProgressionDrill _drill = null!;
    private bool _answered;
    private bool _ready;

    public TriadProgressionsL1C7Page()
    {
        InitializeComponent();
    ...
    private IReadOnlyList<L1C7ProgressionDrill> Set =>
        ThreeChord ? L1C7ProgressionDrill.ThreeChord : L1C7ProgressionDrill.TwoChord;

    private List<L1C7ProgressionDrill> Playable()
    {
    ...
    private async Task PlayDrillAsync(L1C7ProgressionDrill drill)
    {
