...
public partial class DictationL1C3Page : ContentPage
{
    ...
    public DictationL1C3Page()
    {
        ...
        C2Switch.Toggled += OnSettingChanged;
    ...
    private L1C3DictationInterval Interval => Toggle.Quality switch
    {
        IntervalQuality.Minor3rd => L1C3DictationInterval.Minor3rd,
        IntervalQuality.Major6th => L1C3DictationInterval.Major6th,
        _ => L1C3DictationInterval.Both,
    };
    ...
    private bool IncludeC2 => C2Switch.IsToggled;

    private void NewDrill()
    {
        _drill = IntervalDictationDrill.Next(Interval, Key, Bpm, Measures, IncludeEighths, IncludeC2, _rng);
