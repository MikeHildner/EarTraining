...
public partial class TriadRecognitionL1C7Page : ContentPage, IAutomatableDrill
{
    ...
    private readonly IReadOnlyList<DiatonicTriadDrill> _all = DiatonicTriadDrill.All(6); // I/IV/V/vi/iii/ii
    private DiatonicTriadDrill _drill = null!;
    private bool _answered;
    private bool _ready;

    public TriadRecognitionL1C7Page()
    {
        InitializeComponent();
