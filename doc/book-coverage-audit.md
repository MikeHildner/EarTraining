...
| **C6** — Maj 2nd + Min 7th; **dotted quarter-eighth rhythms**; triads add III | L1C6 (5 pages) | ◑ drills ✅; ❌ no C6 dictation (dotted rhythms unsupported by the dictation engine) |
...
| **C8 — Review**: ALL-interval melodic ID + harmonic ID (16 Q each), melodic dictation, triad recognition, bass-line dictation, in G/F/D/Bb | — | ❌ missing. Closest is "Not in the Books → Interval ID", but that is chromatic root-based, not diatonic-solfeg |
